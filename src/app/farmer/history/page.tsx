                            ...
                            <tbody>
                                {orders.map((order) => (
                                    <tr key={order.id} className="border-b hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-right font-bold text-farmer-green">{formatMoney(order.total_price)}</td>
                        ...
                        {orders.map((order) => (
                            <div key={order.id} className="rounded-lg bg-white p-4 shadow-sm space-y-2">
                                ...
                                <div className="flex items-center gap-4 text-sm text-gray-700">
                                    ...
                                    <span className="font-bold text-farmer-green">{formatMoney(order.total_price)}</span>
                                </div>
